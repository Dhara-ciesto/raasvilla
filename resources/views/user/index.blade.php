            ...
            <div class="card-body">
                ...
                <div class="table-rep-plugin">
                    <div class="table-responsive mb-0" data-pattern="priority-columns">
                        ...
                        <table id="member_list_table" class="table table-striped" data-unique-id="id" data-toggle="table" data-ajax="ajaxRequest" data-side-pagination="server" data-pagination="true" data-total-field="count" data-data-field="items" data-show-columns="true" data-show-toggle="false" data-filter-control="true" data-show-columns-toggle-all="true" >
                            <thead>
                                <tr>
                                    <th data-field="counter" data-sortable="true">{{__('#')}}</th>
                                    <th data-field="member_id" data-filter-control="input" data-sortable="true">{{__('Member ID')}}</th>
                                    <th data-field="full_name" data-filter-control="input" data-sortable="true">{{__('Full Name')}}</th>
                                    <th data-field="entry_type" data-filter-control="input" data-sort-name="entry_type" data-flat="true" data-sortable="true">{{__('Entry As')}}</th>
                                    <th data-field="mobile_no" data-filter-control="input" data-sortable="true">{{__('Mobile No')}}</th>
                                    <th data-field="instagram_id" data-filter-control="input" data-sortable="true">{{__('Instagram ID')}}</th>
                                    <th data-field="photo" data-filter-control="input" data-sortable="true">{{__('Photo')}}</th>
                                    <th data-field="status" data-filter-control="select" data-sortable="true">{{__('Status')}}</th>
        ...
        , columns: [
            ...
            , {
                ...
                , formatter: function(value, row, index) {
                    ...
                    let action = `<button type="button" onClick="changeStatus(${row.id}, ${index}, '${status_value}')" class="btn btn-sm `+class_name+`">`+status+`</button>`;
                    return action;
                }
            }
        ]
