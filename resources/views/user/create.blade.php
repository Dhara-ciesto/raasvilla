                                                            ...
                                                            <div class="repeater" id="repeater">
                                                                ...
                                                                <div data-repeater-list="group_a" class="outer">
                                                                    ...
                                                                    <div data-repeater-item class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                <label for="instagram_id">Member Name <span
                                                                                        class="text-danger">*</span></label>
                                                                                <input type="text" class="form-control"
                                                                                    id="member_name" autocomplete="off"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                <label for="instagram_id">Instagram ID
                                                                                    <span
                                                                                        class="text-danger">*</span></label>
                                                                                <input type="text" class="form-control"
                                                                                    autocomplete="off"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="mb-3">
                                                                                <label for="DOB"
                                                                                    class="form-label">ID Proof<span
                                                                                        class="error">*</span></label>
                                                                                <input type="file" class="form-control"
                                                                                    id="mem_id_proof" autocomplete="off"
                                                                        ...
                                                                        <div class="col-lg-12 delete my-3">
                                                                            <span data-repeater-delete class="float-end"
                                                                                type="button"><i
                                                                                    class='bx bxs-trash-alt bx-xs error'></i></span>
                                                                        </div>
                                                                    </div>
